...
public class ContactsWithPaginationQuery : ContactAdvancedFilter, ICacheableRequest<PaginatedData<ContactDto>>
{
    ...
    {
        return $"Listview:{ListView}:{CurrentUser?.UserId}-{LocalTimezoneOffset.TotalHours}, Search:{Keyword},{TaxIdentificationNumber}, {PublicFinancialService} {OrderBy}, {SortDirection}, {PageNumber}, {PageSize}";
    }
